...
> = {
	...
	histories?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['CommentHistory']>>>,
		ParentType,
		ContextType
	>;
	id?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type CommentHistoryResolvers<
	ContextType = any,
	ParentType extends ResolversParentTypes['CommentHistory'] = ResolversParentTypes['CommentHistory'],
> = {
	body?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
	id?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
	timestamp?: Resolver<
...
> = {
	...
	archiveThread?: Resolver<
		...
		ParentType,
		ContextType,
		Partial<MutationArchiveThreadArgs>
	>;
	...
	editComment?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationEditCommentArgs, 'input'>
	>;
	editThread?: Resolver<
		Maybe<ResolversTypes['Thread']>,
		ParentType,
		ContextType,
		RequireFields<MutationEditThreadArgs, 'input'>
	>;
	emailConfirmedOrder?: Resolver<
		Maybe<ResolversTypes['TokenOrder']>,
		ParentType,
		ContextType,
		Partial<MutationEmailConfirmedOrderArgs>
	>;
	...
	upVote?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationUpVoteArgs, 'id'>
	>;
};
...
> = {
	...
	feedThreads?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['Thread']>>>,
		ParentType,
		ContextType
	>;
	findThreads?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['Thread']>>>,
		ParentType,
		ContextType,
		RequireFields<QueryFindThreadsArgs, 'keyword'>
	>;
	...
	>;
	personalThreads?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['Thread']>>>,
		ParentType,
		ContextType,
		Partial<QueryPersonalThreadsArgs>
	>;
	profile?: Resolver<
		Maybe<ResolversTypes['Profile']>,
		ParentType,
...
> = {
	...
	>;
	histories?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['ThreadHistory']>>>,
		ParentType,
		ContextType
	>;
	id?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type ThreadHistoryResolvers<
	ContextType = any,
	ParentType extends ResolversParentTypes['ThreadHistory'] = ResolversParentTypes['ThreadHistory'],
> = {
	body?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
	id?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
	timestamp?: Resolver<
